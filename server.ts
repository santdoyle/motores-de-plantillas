...
router.get('/public', (req: any, resp: any) => {
...
server.on('error', (error: string) => console.log(`Ocurrió un error: ${error}`))
...
io.on('connection', (socket: any) => {
    ...
    socket.on('evento-chat', (data: Array<Object>) => {
        console.log(data)
...
let listaProductos: Array<Object> = []
